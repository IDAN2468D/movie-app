...
jest.mock('react-native-reanimated', () => {
  ...
  return {
    ...
    FadeInLeft: makeLayoutAnimationMock(),
    FadeInRight: makeLayoutAnimationMock(),
    FadeOutDown: makeLayoutAnimationMock(),
    FadeOutLeft: makeLayoutAnimationMock(),
    FadeOutRight: makeLayoutAnimationMock(),
    SlideInRight: makeLayoutAnimationMock(),
    SlideInLeft: makeLayoutAnimationMock(),
